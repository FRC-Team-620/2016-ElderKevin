 ...
 *
 */
public class Devour extends Command {
    ...
    protected void execute() {
        ...
        System.out.println("DEVOURING: IN PROGRESS");
        System.out.println("timer is " + timer.get());
        System.out.println(Robot.dOB.hasBall());
    ...
    protected boolean isFinished() {
        ...
        // if sensor reads a ball, set finish time
        if (Robot.dOB.hasBall()) {
            if (finishTime == 0) {
    			finishTime = timer.get() + .35; // extra .35s, final value TBD
            }
        }
...
//        	System.out.println("DEVOURING IS FINISHED");
//            return true;
//        } 
    }
